...
import 'package:wedding_dress_shop/dress_model.dart';
import 'package:wedding_dress_shop/screens/dress_screen.dart';
      ...
      child: GestureDetector(
        onTap: (){
          Navigator.push(context, MaterialPageRoute(
            builder: (_)=>DressScreen(dress:dress)
          ));
        },
        child: Stack(
          children: <Widget>[
