...
import 'package:wedding_dress_shop/constants.dart';
import 'package:wedding_dress_shop/screens/home_screen.dart';
import 'package:wedding_dress_shop/widgets/build_stars.dart';
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: ListView(
              ...
              children: <Widget>[
                Text(widget.dress.title,style: TextStyle(
                  fontSize: 20.0,
                ...
                Text('\MMK ${widget.dress.price}',style: TextStyle(
                  fontSize: 24.0,
                  fontWeight: FontWeight.bold
                ),),
                SizedBox(height: 20.0,),
                Text('အသေးစိတ်ထုတ်ကုန်',style: TextStyle(
                  fontSize: 18.0,
                ...
                Container(
                  ...
                  RichText(
                    ...
                    style: TextStyle(
                      ...
                      children: <TextSpan>[
                        TextSpan(
                         text: flag?" ဆက်ဖတ်ရန်":" လျော့နည်းဖတ်ပါ",
                          style: TextStyle(
                            color: kAccentColor,
                            fontWeight: FontWeight.bold
                          ),
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Center(child: Text('ရက်ချိန်းယူပါ',
                      style: TextStyle(
                        color: Colors.white,
                        fontSize: 16.0,
                        fontWeight: FontWeight.w500
